...
* TODO libjit
  ...
  - [ ] add the tail handling compiler

  - [ ] run with DONE/ABORT only

  - [ ] add stack handling routines

  - [ ] add everything but the branching instructions

  - [ ] finish the branching instruction
