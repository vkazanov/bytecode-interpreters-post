...
interpret_result vm_interpret(uint8_t *bytecode)
{
   ...
   1. Добыть опкод из потока инструкций.

   2. Убедиться, что опкод входит в допустимый интервал значений опкодов.

   3. Перейти к телу инструкции.

   4. Произвести действия со стеком.

   5. Выполнить, собственно операцию.

   6. Положить результат обратно на стек.

   Словом, у Поросенка явно превышен допустимый индекс массы тела, и если мы хотим привести нашего
   хряка в форму, то придется как-то со всеми этим излишествами бороться.
